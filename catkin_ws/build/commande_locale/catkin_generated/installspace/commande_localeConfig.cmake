...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'commande_locale' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/etudiant/CelluleFlexible/catkin_ws/install/${idir}'.  Ask the maintainer 'Simon Demmer <simon.demmer@etu.enseeiht.fr>' to fix it.")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/etudiant/CelluleFlexible/catkin_ws/install/lib;/home/etudiant/CelluleFlexible/catkin_ws/devel/lib;/opt/ros/jade/lib)
