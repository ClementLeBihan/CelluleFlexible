...
void sensorState::SensorCallback(const commandeLocale::Msg_SensorState::ConstPtr& msg)
...
{
	subSensorState = n.subscribe("/commandeLocale/SensorState", 1, &sensorState::SensorCallback,this);
}
