...
void UI::DrawSwitchSensorImg(commandeLocale::Msg_SensorState SensorState)
{
...
void UI::DrawStationSensorImg(commandeLocale::Msg_SensorState SensorState)
{
...
void UI::DrawRailSensorImg(commandeLocale::Msg_SensorState SensorState)
{
...
void UI::update()
{
	imageSimu.copyTo(imageTot.rowRange(18,530).colRange(78,1102));
 	...
 	cv::imshow("commandeLocale", imageTot);
}
...
void UI::init(ros::NodeHandle nh){
	...
	// Window
		cv::namedWindow("commandeLocale");
		cv::startWindowThread();
		cv::moveWindow("commandeLocale",0,0);
		cv::setMouseCallback("commandeLocale", onMouse,this);
	// Subscribe
